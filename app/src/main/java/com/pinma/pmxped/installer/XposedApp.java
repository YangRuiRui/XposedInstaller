...
import com.pinma.pmxped.installer.util.AssetUtil;
import com.pinma.pmxped.installer.util.DownloadsUtil;
import com.pinma.pmxped.installer.util.InstallZipUtil;
import com.pinma.pmxped.installer.util.InstallZipUtil.XposedProp;
import com.pinma.pmxped.installer.util.NotificationUtil;
...
public class XposedApp extends Application implements ActivityLifecycleCallbacks {
    ...
    private static final String BASE_DIR_LEGACY = "/data/data/com.pinma.pmxped.installer/";

    public static final String BASE_DIR = Build.VERSION.SDK_INT >= 24
            ? "/data/user_de/0/com.pinma.pmxped.installer/" : BASE_DIR_LEGACY;
    ...
    private static final String[] XPOSED_PROP_FILES = new String[]{
            "/su/xposed/pmxped.prop", // official systemless
            "/system/pmxped.prop",    // classical
    };
    ...
    public static void installApk(Context context, DownloadsUtil.DownloadInfo info) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            uri = FileProvider.getUriForFile(context, "com.pinma.pmxped.installer.fileprovider", new File(info.localFilename));
