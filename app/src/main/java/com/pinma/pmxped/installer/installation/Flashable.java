...
import com.pinma.pmxped.installer.util.InstallZipUtil.ZipCheckResult;
import com.pinma.pmxped.installer.util.RootUtil;

import static com.pinma.pmxped.installer.util.InstallZipUtil.closeSilently;
import static com.pinma.pmxped.installer.util.InstallZipUtil.reportMissingFeatures;
import static com.pinma.pmxped.installer.util.InstallZipUtil.triggerError;
...
public abstract class Flashable implements Parcelable {
    ...
    protected Flashable(Parcel in) {
        ...
        mType = (com.pinma.pmxped.installer.util.FrameworkZips.Type) in.readSerializable();
